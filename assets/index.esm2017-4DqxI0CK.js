import{bF as mi,bG as f,bH as ge,bI as Lt,bJ as yi,bK as vi,bL as Ci,bM as Ei,bN as Ii,bO as wi,bP as yn,bQ as R,bR as Ft,bS as q,bT as Ti,bU as Si,bV as Ni,bW as ue,bX as Qe,bY as Wt,bZ as We,b_ as Ri,b$ as ts,c0 as bi,c1 as ki,c2 as vn,c3 as ns,c4 as Pi,c5 as xi,c6 as at,c7 as Ai,c8 as Mi,c9 as Di}from"./index-De8-AJ5t.js";var Cn={};const En="@firebase/database",In="1.0.7";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fi{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return q(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class er{constructor(){this.counters_={}}incrementCounter(e,t=1){q(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return Ai(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yt={},vt={};function qt(n){const e=n.toString();return yt[e]||(yt[e]=new er),yt[e]}function tr(n,e){const t=n.toString();return vt[t]||(vt[t]=e()),vt[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Rt;function Or(n){Rt=n}const Ps=function(n){return typeof n=="number"?"number:"+ls(n):"string:"+n},xs=function(n){if(n.isLeafNode()){const e=n.val();f(typeof e=="string"||typeof e=="number"||typeof e=="object"&&q(e,".sv"),"Priority must be a string or number.")}else f(n===Rt||n.isEmpty(),"priority of unexpected type.");f(n===Rt||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qr=!0;function P(n,e=null){if(n===null)return p.EMPTY_NODE;if(typeof n=="object"&&".priority"in n&&(e=n[".priority"]),f(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof n=="object"&&".value"in n&&n[".value"]!==null&&(n=n[".value"]),typeof n!="object"||".sv"in n){const t=n;return new b(t,P(e))}if(!(n instanceof Array)&&qr){const t=[];let s=!1;if(A(n,(o,l)=>{if(o.substring(0,1)!=="."){const a=P(l);a.isEmpty()||(s=s||!a.getPriority().isEmpty(),t.push(new m(o,a)))}}),t.length===0)return p.EMPTY_NODE;const r=Xe(t,Dr,o=>o.name,Kt);if(s){const o=Xe(t,N.getCompare());return new p(r,P(e),new H({".priority":o},{".priority":N}))}else return new p(r,P(e),H.Default)}else{let t=p.EMPTY_NODE;return A(n,(s,i)=>{if(q(n,s)&&s.substring(0,1)!=="."){const r=P(i);(r.isLeafNode()||!r.isEmpty())&&(t=t.updateImmediateChild(s,r))}}),t.updatePriority(P(e))}}Lr(P);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Un=10*1e3,Jr=30*1e3,Zr=5*60*1e3;class eo{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Xr(e);const s=Un+(Jr-Un)*Math.random();Se(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),t={};let s=!1;A(e,(i,r)=>{r>0&&q(this.statsToReport_,i)&&(t[i]=r,s=!0)}),s&&this.server_.reportStats(t),Se(this.reportStats_.bind(this),Math.floor(Math.random()*2*Zr))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class G{constructor(e){this.writeTree_=e}static empty(){return new G(new I(null))}}function Re(n,e,t){if(y(e))return new G(new I(t));{const s=n.writeTree_.findRootMostValueAndPath(e);if(s!=null){const i=s.path;let r=s.value;const o=D(i,e);return r=r.updateChild(o,t),new G(n.writeTree_.set(i,r))}else{const i=new I(t),r=n.writeTree_.setTree(e,i);return new G(r)}}}function kt(n,e,t){let s=n;return A(t,(i,r)=>{s=Re(s,S(e,i),r)}),s}function Gn(n,e){if(y(e))return G.empty();{const t=n.writeTree_.setTree(e,new I(null));return new G(t)}}function Pt(n,e){return re(n,e)!=null}function re(n,e){const t=n.writeTree_.findRootMostValueAndPath(e);return t!=null?n.writeTree_.get(t.path).getChild(D(t.path,e)):null}function Vn(n){const e=[],t=n.writeTree_.value;return t!=null?t.isLeafNode()||t.forEachChild(N,(s,i)=>{e.push(new m(s,i))}):n.writeTree_.children.inorderTraversal((s,i)=>{i.value!=null&&e.push(new m(s,i.value))}),e}function z(n,e){if(y(e))return n;{const t=re(n,e);return t!=null?new G(new I(t)):new G(n.writeTree_.subtree(e))}}function xt(n){return n.writeTree_.isEmpty()}function pe(n,e){return Fs(C(),n.writeTree_,e)}function Fs(n,e,t){if(e.value!=null)return t.updateChild(n,e.value);{let s=null;return e.children.inorderTraversal((i,r)=>{i===".priority"?(f(r.value!==null,"Priority writes must always be leaf nodes"),s=r.value):t=Fs(S(n,i),r,t)}),!t.getChild(n).isEmpty()&&s!==null&&(t=t.updateChild(S(n,".priority"),s)),t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ut(n,e){return Vs(e,n)}function oo(n,e,t,s,i){f(s>n.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),n.allWrites.push({path:e,snap:t,writeId:s,visible:i}),i&&(n.visibleWrites=Re(n.visibleWrites,e,t)),n.lastWriteId=s}function lo(n,e,t,s){f(s>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:s,visible:!0}),n.visibleWrites=kt(n.visibleWrites,e,t),n.lastWriteId=s}function ao(n,e){for(let t=0;t<n.allWrites.length;t++){const s=n.allWrites[t];if(s.writeId===e)return s}return null}function co(n,e){const t=n.allWrites.findIndex(l=>l.writeId===e);f(t>=0,"removeWrite called with nonexistent writeId.");const s=n.allWrites[t];n.allWrites.splice(t,1);let i=s.visible,r=!1,o=n.allWrites.length-1;for(;i&&o>=0;){const l=n.allWrites[o];l.visible&&(o>=t&&ho(l,s.path)?i=!1:F(s.path,l.path)&&(r=!0)),o--}if(i){if(r)return uo(n),!0;if(s.snap)n.visibleWrites=Gn(n.visibleWrites,s.path);else{const l=s.children;A(l,a=>{n.visibleWrites=Gn(n.visibleWrites,S(s.path,a))})}return!0}else return!1}function ho(n,e){if(n.snap)return F(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&F(S(n.path,t),e))return!0;return!1}function uo(n){n.visibleWrites=Ws(n.allWrites,fo,C()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function fo(n){return n.visible}function Ws(n,e,t){let s=G.empty();for(let i=0;i<n.length;++i){const r=n[i];if(e(r)){const o=r.path;let l;if(r.snap)F(t,o)?(l=D(t,o),s=Re(s,l,r.snap)):F(o,t)&&(l=D(o,t),s=Re(s,C(),r.snap.getChild(l)));else if(r.children){if(F(t,o))l=D(t,o),s=kt(s,l,r.children);else if(F(o,t))if(l=D(o,t),y(l))s=kt(s,C(),r.children);else{const a=ue(r.children,v(l));if(a){const c=a.getChild(w(l));s=Re(s,C(),c)}}}else throw We("WriteRecord should have .snap or .children")}}return s}function Us(n,e,t,s,i){if(!s&&!i){const r=re(n.visibleWrites,e);if(r!=null)return r;{const o=z(n.visibleWrites,e);if(xt(o))return t;if(t==null&&!Pt(o,C()))return null;{const l=t||p.EMPTY_NODE;return pe(o,l)}}}else{const r=z(n.visibleWrites,e);if(!i&&xt(r))return t;if(!i&&t==null&&!Pt(r,C()))return null;{const o=function(c){return(c.visible||i)&&(!s||!~s.indexOf(c.writeId))&&(F(c.path,e)||F(e,c.path))},l=Ws(n.allWrites,o,e),a=t||p.EMPTY_NODE;return pe(l,a)}}}function _o(n,e,t){let s=p.EMPTY_NODE;const i=re(n.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(N,(r,o)=>{s=s.updateImmediateChild(r,o)}),s;if(t){const r=z(n.visibleWrites,e);return t.forEachChild(N,(o,l)=>{const a=pe(z(r,new E(o)),l);s=s.updateImmediateChild(o,a)}),Vn(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const r=z(n.visibleWrites,e);return Vn(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function po(n,e,t,s,i){f(s||i,"Either existingEventSnap or existingServerSnap must exist");const r=S(e,t);if(Pt(n.visibleWrites,r))return null;{const o=z(n.visibleWrites,r);return xt(o)?i.getChild(t):pe(o,i.getChild(t))}}function go(n,e,t,s){const i=S(e,t),r=re(n.visibleWrites,i);if(r!=null)return r;if(s.isCompleteForChild(t)){const o=z(n.visibleWrites,i);return pe(o,s.getNode().getImmediateChild(t))}else return null}function mo(n,e){return re(n.visibleWrites,e)}function yo(n,e,t,s,i,r,o){let l;const a=z(n.visibleWrites,e),c=re(a,C());if(c!=null)l=c;else if(t!=null)l=pe(a,t);else return[];if(l=l.withIndex(o),!l.isEmpty()&&!l.isLeafNode()){const h=[],u=o.getCompare(),d=r?l.getReverseIteratorFrom(s,o):l.getIteratorFrom(s,o);let _=d.getNext();for(;_&&h.length<i;)u(_,s)!==0&&h.push(_),_=d.getNext();return h}else return[]}function vo(){return{visibleWrites:G.empty(),allWrites:[],lastWriteId:-1}}function nt(n,e,t,s){return Us(n.writeTree,n.treePath,e,t,s)}function Jt(n,e){return _o(n.writeTree,n.treePath,e)}function qn(n,e,t,s){return po(n.writeTree,n.treePath,e,t,s)}function st(n,e){return mo(n.writeTree,S(n.treePath,e))}function Co(n,e,t,s,i,r){return yo(n.writeTree,n.treePath,e,t,s,i,r)}function Zt(n,e,t){return go(n.writeTree,n.treePath,e,t)}function Gs(n,e){return Vs(S(n.treePath,e),n.writeTree)}function Vs(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
